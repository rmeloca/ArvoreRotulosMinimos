...
public class GrafoMatrizAdjacenciaTest {
	...
	public void testeVertice() {
		Grafo<Vertice, Aresta<Vertice, Vertice>> g = GrafoFactory
				.constroiGrafo(Representacao.MATRIZ_ADJACENCIA, Orientacao.DIRIGIDO);
	...
	public void testeAresta() {
		...
		Aresta<Vertice, Vertice> a1 = new Aresta<>(v1, v2);
		g.adicionaAresta(a1);
		...
		Aresta<Vertice, Vertice> a2 = new Aresta<>(v3, v4);
		g.adicionaAresta(a2);
		...
		Aresta<Vertice, Vertice> a3 = new Aresta<>(v5, v6);
		g.adicionaAresta(a3);		
